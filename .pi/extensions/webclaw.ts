...
- You need interaction, DOM inspection, or rendered state`,
		promptSnippet: "Scrape a URL with webclaw for token-efficient content extraction and bot-protected pages.",
		parameters: Type.Object({
			...
			onlyMainContent: Type.Optional(
				Type.Boolean({ description: "Auto-detect and return only the main content. Default: true" }),
			),
