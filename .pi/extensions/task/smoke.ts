...
try {
  ...
  const { discoverAgents } = await import("./helpers.js");
  ...
  const { buildPiArgs, ALL_TOOL_NAMES } = await import("./helpers.js");
...
try {
  ...
  const { buildPiArgs, discoverAgents: da } = await import("./helpers.js");
...
const { formatAgentList, parseResultXml } = await import("./helpers.js");
...
const { countToolUses } = await import("./helpers.js");
