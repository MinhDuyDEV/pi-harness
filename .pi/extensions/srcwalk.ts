  ...
  registerTool(
    ...
    Type.Object({
      ...
      context: Type.Optional(
        Type.String({
          description:
            "Path to file being edited — boosts nearby results. v1.0.1: Enhanced to prefer confirmed context targets.",
        }),
      ),
  ...
  registerTool(
    ...
    Type.Object({
      ...
      contextLines: Type.Optional(
        Type.Number({
          description:
            "Number of context lines to show around matches (like grep -C). v1.0.1 feature.",
        }),
      ),
      budget: Type.Optional(Type.Number({ description: "Max tokens in response." })),
    }),
