...
function markdown({ endpoint, version, pages, page, title, url, evalResults, events }) {
	return `# Browser DevTools Report

**Endpoint:** ${endpoint}
**Generated:** ${new Date().toISOString()}
**Browser:** ${version.Browser ?? "unknown"}
**Selected page:** ${title || "(untitled)"}
**URL:** ${url || page.url || "unknown"}
...
async function main() {
	...
	try {
		...
		const report = markdown({ endpoint, version, pages, page, title: page.title, url: args.url, evalResults, events: cdp.events });
