...
- **Compaction plugin** (`.pi/extensions/compaction.ts`): Session continuity, beads state, handoff recovery, post-compaction protocol (fires during compaction events only)
