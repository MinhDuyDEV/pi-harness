...
/skill:beads-bridge; // Swarm coordination
/skill:swarm-coordination; // Parallel execution
/skill:frontend-design; // UI implementation
/skill:prd; // Requirements documents
```
