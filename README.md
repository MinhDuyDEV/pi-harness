...
```bash
mkdir -p ./my-repo
npx --yes --package @minhduydev/pi-harness@2.3.0 pi-harness-init ./my-repo
```
...
```bash
npx --yes --package @minhduydev/pi-harness@2.3.0 pi-harness-init --dry-run ./my-repo
```
...
4. [`@minhduydev/pi-todo@0.4.1`](https://www.npmjs.com/package/@minhduydev/pi-todo/v/0.4.1)
5. [`@minhduydev/pi-harness@2.3.0`](https://www.npmjs.com/package/@minhduydev/pi-harness/v/2.3.0)
